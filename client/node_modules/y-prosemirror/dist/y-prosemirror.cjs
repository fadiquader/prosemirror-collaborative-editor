 ...
 * @return {any}
 */
const yCursorPlugin = (awareness, { cursorBuilder = defaultCursorBuilder, getSelection = state => state.selection } = {}) => new prosemirrorState.Plugin({
...
exports.createNodeIfNotExists = createNodeIfNotExists;
